...
Please refer to https://github.com/webmaeistro/gatsby-theme-banshorian if you wish to use this for your own site, this repo will be under development and not to be use in a prodcution enviroment at this time.
...
yarn init -y
yarn add react react-dom gatsby @webmaeistro/gatsby-theme-banshorian
```
...
module.exports = {
  plugins: [
    {
      resolve: `@webmaeistro/gatsby-theme-banshorian`,
    },
  ],
}
```
  ...
  plugins: [
    {
      ...
      options: {
        ...
        siteTitle: `Portfolio`,
        siteUrl: `https://www.martin-andersen.com`,
...
```js
// src/@webmaeistro/gatsby-theme-banshorian/layout/layoutColors.css.js
...
You can change the about-me text in the "src/@webmaeistro/gatsby-theme-banshorian/contentJSON/about-me.json" file, for example:
